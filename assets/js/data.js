...
const PRODUCTS = [
  ...
  { id: 'p7', name: 'Set de Teclado y Mouse', slug: 'set-teclado-mouse', categorySlug: 'electronica', description: 'Combo inalámbrico cómodo y silencioso.', image: './assets/img/products/set-teclado-mouse.jpg', price: 25990, isNew: false },
  { id: 'p8', name: 'Libro: HTML y CSS Básico', slug: 'html-css-basico', categorySlug: 'libros', description: 'Crea tus primeras páginas web desde cero.', image: './assets/img/products/htmlycssbasico.jpeg', price: 15990, isNew: false },
  { id: 'p9', name: 'Almohada Ergonómica', slug: 'almohada-ergonomica', categorySlug: 'hogar', description: 'Descanso óptimo para tu cuello.', image: './assets/img/products/almohada.jpg', price: 9990, isNew: false },
  { id: 'p10', name: 'Chaqueta Impermeable', slug: 'chaqueta-impermeable', categorySlug: 'moda', description: 'Protección y estilo para cualquier clima.', image: './assets/img/products/chaqueta.jpeg', price: 39990, isNew: false },
  { id: 'p11', name: 'Set de Bloques Creativos', slug: 'bloques-creativos', categorySlug: 'juguetes', description: 'Estimula la imaginación con horas de juego.', image: './assets/img/products/setbloquescreativos.jpg', price: 11990, isNew: false },
  { id: 'p12', name: 'Libro: Accesibilidad Web', slug: 'accesibilidad-web', categorySlug: 'libros', description: 'Buenas prácticas para sitios inclusivos.', image: './assets/img/products/accesabilidad.jpeg', price: 18990, isNew: false },
];
